...
string generateName(int gender, int race){
    ...
    if(gender == 0){
        string firstname = boyFirstNames[rand() % FNAME_NUM];   
    }
    else if(gender == 1){
        string firstname = girlFirstNames[rand() % FNAME_NUM];
    }
    else{
    ...
    if(race == 0){
        string lastname = caucasianLastNames[rand() % LNAME_NUM];
    }
    else if(race == 1){
        string lastname = hispanicLastNames[rand() % LNAME_NUM];
    }
    else if(race == 2 || race == 3){
        string lastname = nativeLastNames[rand() % LNAME_NUM];
    }
    else if(race == 4 || race == 5){
        string lastname = asianLastNames[rand() % LNAME_NUM];
    }
    else if(race == 6){
        if((rand() % 2 + 1) == 1){
            string lastname = nativeLastNames[rand() % LNAME_NUM];
